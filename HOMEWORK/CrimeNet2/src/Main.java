public class Main {
	...
	public static void main(String[] args) {
		...
		//-------------TESTS---------------
		Suspect A = new Suspect ("A", "A", "A");
		Suspect B = new Suspect ("B", "B", "B");
		Suspect D = new Suspect ("D", "D", "D");
		Suspect E = new Suspect ("E", "E", "E");
		Suspect C = new Suspect ("C", "C", "C");
		
		A.addPossibleSuspect(B);
		A.addPossibleSuspect(D);
		B.addPossibleSuspect(E);
		B.addPossibleSuspect(D);
		C.addPossibleSuspect(A);
		C.addPossibleSuspect(D);
		
		for(Suspect s : E.getSuggestedPartners())
		{
